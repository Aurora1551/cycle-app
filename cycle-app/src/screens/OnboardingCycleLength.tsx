  ...
  return (
    <div className="fade-in w-full flex-center" style={{ opacity: visible ? 1 : 0 }}>
      <OnboardingLayout step={3} totalSteps={6} bg={BG} accent={A} text={T} muted={M} onBack={onBack}>
        ...
        <button onClick={() => onContinue(28)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontFamily: "'Karla', sans-serif", fontSize: 12, color: M, padding: '10px 0 0', width: '100%', textAlign: 'center' }}>
          Skip for now
        </button>
      </OnboardingLayout>
    </div>
