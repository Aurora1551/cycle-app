  ...
  return (
    <div className="screen fade-in" style={{ opacity: visible ? 1 : 0, background: bg }}>
      ...
      <div className="content" style={{ gap: 14 }}>
        ...
        <button onClick={() => onContinue(['pop', 'ambient'])} className="body-font" style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: muted, padding: '12px 0', minHeight: 44, width: '100%', textAlign: 'center' }}>
          Skip for now
        </button>
      </div>
    </div>
