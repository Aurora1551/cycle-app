...
export const VIBE_CONTENT: Record<string, {
  ...
  fierce: {
    ...
    labels: {
      ...
      breathing: { emoji: '🌬️', text: 'BREATHE' },
    },
  ...
  nurturing: {
    ...
    labels: {
      ...
      gratitude: { emoji: '💛', text: "TODAY'S GRATITUDE" },
      breathing: { emoji: '🌬️', text: 'BREATHE GENTLY' },
    },
  ...
  calm: {
    ...
    labels: {
      ...
      gratitude: { emoji: '💛', text: "TODAY'S GRATITUDE" },
      breathing: { emoji: '🌬️', text: 'FIND YOUR BREATH' },
    },
  ...
  lighthearted: {
    ...
    labels: {
      ...
      gratitude: { emoji: '💛', text: "TODAY'S GRATITUDE" },
      breathing: { emoji: '🌬️', text: 'SUNSHINE BREATH' },
    },
  ...
  spiritual: {
    ...
    labels: {
      ...
      gratitude: { emoji: '💛', text: "TODAY'S GRATITUDE" },
      breathing: { emoji: '🌬️', text: 'SACRED BREATH' },
    },
